...
The Golang SDK for the DataGovAu API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/data-gov-au-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/data-gov-au-sdk=../path/to/github.com/voxgig-sdk/data-gov-au-sdk
```
...
```
github.com/voxgig-sdk/data-gov-au-sdk/
...
The root package (`github.com/voxgig-sdk/data-gov-au-sdk`) re-exports everything needed
