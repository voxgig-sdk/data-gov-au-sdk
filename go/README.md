# DataGovAu Golang SDK



The Golang SDK for the DataGovAu API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/data-gov-au-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/data-gov-au-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/data-gov-au-sdk/go=../data-gov-au-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DataGovAuSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### DataGovAuSDK methods
...
All entities implement the `DataGovAuEntity` interface.
...
API path: `/action/package_search`
...
API path: `/action/organization_list`
...
| `facets` | `map[string]any` | Faceted search results for aggregation |
| `id` | `string` |  |
| `license_id` | `string` |  |
...
| `resources` | `[]any` |  |
| `results` | `[]any` |  |
| `search_facets` | `map[string]any` | Search facet information |
| `tags` | `[]any` |  |
| `title` | `string` |  |
...
```
github.com/voxgig-sdk/data-gov-au-sdk/go/
├── data-gov-au.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/data-gov-au-sdk/go`) re-exports everything needed
