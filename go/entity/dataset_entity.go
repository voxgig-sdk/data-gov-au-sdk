...
func NewDatasetEntity(client *core.DataGovAuSDK, entopts map[string]any) *DatasetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatasetEntity) GetName() string { return e.name }
...
func (e *DatasetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DatasetEntity) Deleted() bool {
	return e.deleted
}


func (e *DatasetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDatasetEntity(e.client, opts)
}

func (e *DatasetEntity) Data(args ...any) any {
...
func (e *DatasetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Dataset; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DatasetEntity) DataTyped(data ...Dataset) Dataset {
	if len(data) > 0 {
		return typedFrom[Dataset](e.Data(asMap(data[0])))
	}
	return typedFrom[Dataset](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Dataset (all fields
// optional at the wire level).
func (e *DatasetEntity) MatchTyped(match ...Dataset) Dataset {
	if len(match) > 0 {
		return typedFrom[Dataset](e.Match(asMap(match[0])))
	}
	return typedFrom[Dataset](e.Match())
}
...
func (e *DatasetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DatasetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatasetLoadMatch and returns an Dataset. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DatasetEntity) LoadTyped(reqmatch DatasetLoadMatch, ctrl map[string]any) (Dataset, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Dataset{}, err
	}
	return typedFrom[Dataset](res), nil
}



func (e *DatasetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DatasetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DatasetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DatasetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DatasetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
