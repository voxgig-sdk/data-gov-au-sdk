...
func TestMetadataEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set DATA_GOV_AU_TEST_METADATA_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func metadataBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DATA_GOV_AU_TEST_METADATA_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DATA_GOV_AU_TEST_METADATA_ENTID"])
