...
describe("DatasetDirect", function()
  it("should direct-load-dataset", function()
    local setup = dataset_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dataset", setup.live and "live" or "unit")
...
function dataset_direct_setup(mockres)
