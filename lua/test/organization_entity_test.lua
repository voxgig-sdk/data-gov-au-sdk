...
describe("OrganizationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DATA_GOV_AU_TEST_ORGANIZATION_ENTID JSON to run live")
      return
    end
...
function organization_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DATA_GOV_AU_TEST_ORGANIZATION_ENTID")
