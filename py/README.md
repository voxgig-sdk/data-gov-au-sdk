# DataGovAu Python SDK



The Python SDK for the DataGovAu API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/data-gov-au-sdk/releases)) or
...
client = DataGovAuSDK({
    "apikey": os.environ.get("DATA_GOV_AU_APIKEY"),
})
```
...
```python
client = DataGovAuSDK.test(testopts, sdkopts)
```
...
```
py/
├── datagovau_sdk.py         -- Main SDK module
...
The main module (`datagovau_sdk`) exports the SDK class.
