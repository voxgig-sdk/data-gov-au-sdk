# DataGovAu Python SDK Reference

Complete API reference for the DataGovAu Python SDK.
...
#### `DataGovAuSDK.test(testopts=None, sdkopts=None)`
...
| `facets` | `dict` | No | Faceted search results for aggregation |
| `id` | `str` | No |  |
| `license_id` | `str` | No |  |
...
| `resources` | `list` | No |  |
| `results` | `list` | No |  |
| `search_facets` | `dict` | No | Search facet information |
| `tags` | `list` | No |  |
| `title` | `str` | No |  |
