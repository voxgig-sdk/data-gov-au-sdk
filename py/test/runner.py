...
class DataGovAuTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DataGovAuTestRunner.getenv("DATAGOVAU_TEST_LIVE")
        override = DataGovAuTestRunner.getenv("DATAGOVAU_TEST_OVERRIDE")
        ...
        explain = DataGovAuTestRunner.getenv("DATAGOVAU_TEST_EXPLAIN")
