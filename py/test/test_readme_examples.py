# DataGovAu SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DataGovAuSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DataGovAuSDK(...) and DataGovAuSDK.test(...) become
#      DataGovAuSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "datagovau_sdk"
_SDK_CLASS = "DataGovAuSDK"
