...
from datagovau_sdk.utility import register

# Load features
from datagovau_sdk.feature.base_feature import DataGovAuBaseFeature
from datagovau_sdk.features import _has_feature, _make_feature
...
class DataGovAuSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DataGovAuUtility()
        self._utility = utility

        from datagovau_sdk.config import shared_config
    ...
    def get_utility(self):
        return DataGovAuUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DataGovAuSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dataset(self, data=None) -> "DatasetEntity":
        ...
        from datagovau_sdk.entity.dataset_entity import DatasetEntity
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from datagovau_sdk.entity.metadata_entity import MetadataEntity
    ...
    def Organization(self, data=None) -> "OrganizationEntity":
        ...
        from datagovau_sdk.entity.organization_entity import OrganizationEntity
