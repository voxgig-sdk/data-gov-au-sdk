...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/data-gov-au` | `npm install @voxgig-sdk/data-gov-au` |
| Python | `voxgig-sdk-data-gov-au` | `pip install voxgig-sdk-data-gov-au` |
| PHP | `voxgig-sdk/data-gov-au` | `composer require voxgig-sdk/data-gov-au` |
| Golang | `github.com/voxgig-sdk/data-gov-au-sdk/go` | `go get github.com/voxgig-sdk/data-gov-au-sdk/go` |
| Ruby | `voxgig-sdk-data-gov-au` | `gem install voxgig-sdk-data-gov-au` |
| Lua | `voxgig-sdk-data-gov-au` | `luarocks install voxgig-sdk-data-gov-au` |
