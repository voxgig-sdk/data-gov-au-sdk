...
from projectname_sdk.core.control import DataGovAuControl
...
class DataGovAuContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DataGovAuSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DataGovAuResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DataGovAuResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DataGovAuError(code, msg, self)
