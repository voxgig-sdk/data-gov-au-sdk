...
from projectname_sdk import DataGovAuSDK
from projectname_sdk.core.spec import DataGovAuSpec
from projectname_sdk.core.result import DataGovAuResult
from projectname_sdk.core.response import DataGovAuResponse
from projectname_sdk.core.operation import DataGovAuOperation
from projectname_sdk.core.error import DataGovAuError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DataGovAuBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DataGovAuError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DataGovAuSDK.test(None, None)
        ...
        class TestInitFeature(DataGovAuBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DataGovAuBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DataGovAuSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DataGovAuSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DataGovAuSDK.test(None, setup_opts)
