...
{
    private static function utility(): DataGovAuUtility
    {
        return new DataGovAuUtility();
    }
    ...
    private static function ctx(array $over = []): DataGovAuContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DataGovAuContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DataGovAuOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DataGovAuError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DataGovAuOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DataGovAuMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DataGovAuOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DataGovAuMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DataGovAuOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DataGovAuMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DataGovAuSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DataGovAuMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DataGovAuResponse([]),
            'result' => new DataGovAuResult([]),
        ]);
        [, $err] = DataGovAuMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DataGovAuSpec([]),
            'response' => null,
            'result' => new DataGovAuResult([]),
        ]);
        [, $err] = DataGovAuMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DataGovAuSpec(['step' => 's']),
            'response' => new DataGovAuResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DataGovAuResult([]),
        ]);
        [, $err] = DataGovAuMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DataGovAuSpec(['step' => 's']),
            'response' => new DataGovAuResponse(self::resp(200, ['v' => 1])),
            'result' => new DataGovAuResult([]),
        ]);
        [, $err] = DataGovAuMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DataGovAuSpec(['step' => 's']),
            'response' => new DataGovAuResponse(self::resp(200, ['v' => 2])),
            'result' => new DataGovAuResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DataGovAuMakeResponse::call($ctx);
    ...
    {
        $preset = new DataGovAuResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DataGovAuSpec([]),
            'response' => new DataGovAuResponse([]),
            'result' => new DataGovAuResult([]),
        ...
        [$got, $err] = DataGovAuMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DataGovAuResult([])]);
        [, $err] = DataGovAuMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DataGovAuSpec([]), 'result' => null]);
        [, $err] = DataGovAuMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DataGovAuSpec(['step' => 's']),
            'result' => new DataGovAuResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DataGovAuOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DataGovAuMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DataGovAuSpec(['step' => 's']),
            'result' => new DataGovAuResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DataGovAuOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DataGovAuMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DataGovAuResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DataGovAuSpec([]),
            'result' => new DataGovAuResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DataGovAuMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DataGovAuMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DataGovAuError('boom', 'boom');
        $utility->fetcher = function (DataGovAuContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DataGovAuSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DataGovAuMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DataGovAuContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DataGovAuMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DataGovAuResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DataGovAuContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DataGovAuSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DataGovAuMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DataGovAuResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DataGovAuSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DataGovAuMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DataGovAuMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DataGovAuMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DataGovAuResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DataGovAuDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DataGovAuResult(['ok' => false])]);
        $this->expectException(DataGovAuError::class);
        DataGovAuDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DataGovAuResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DataGovAuMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DataGovAuMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DataGovAuBaseFeature();
        $b = new DataGovAuBaseFeature();
        DataGovAuFeatureAdd::call($ctx, $a);
        DataGovAuFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DataGovAuBaseFeature
    {
        $f = new DataGovAuBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DataGovAuFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DataGovAuContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DataGovAuSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DataGovAuPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DataGovAuResponse(['headers' => null]),
            'result' => new DataGovAuResult([]),
        ]);
        DataGovAuResultHeaders::call($ctx);
