...
// DataGovAu SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DataGovAuTestFeature extends DataGovAuBaseFeature
{
    ...
    public function init(DataGovAuContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DataGovAuContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DataGovAuParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DataGovAuContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DataGovAuContext $ctx, $op, $args): array
    {
