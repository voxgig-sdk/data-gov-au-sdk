...
class DataGovAuNetsimFeature extends DataGovAuBaseFeature
{
    ...
    private function _simulate(DataGovAuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DataGovAuContext $ctx, array $applied): void
    {
        $client = $this->client;
