...
// DataGovAu SDK clienttrack feature
...
class DataGovAuClienttrackFeature extends DataGovAuBaseFeature
{
    ...
    public function PostConstruct(DataGovAuContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DataGovAu-SDK';
