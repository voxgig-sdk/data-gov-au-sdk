...
class DataGovAuRbacFeature extends DataGovAuBaseFeature
{
    ...
    private function _required(DataGovAuContext $ctx): ?string
    {
    ...
    private function _reject(DataGovAuContext $ctx, string $required): void
    {
    ...
    private function _track(DataGovAuContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
