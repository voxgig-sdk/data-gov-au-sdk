...
// DataGovAu SDK utility: fetcher

class DataGovAuFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DataGovAuSDK/1.0)';
    ...
    public static function call(DataGovAuContext $ctx, string $fullurl, array $fetchdef): array
    {
