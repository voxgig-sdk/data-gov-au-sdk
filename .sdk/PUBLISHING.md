...
|---|---|---|
| `ts/` | @voxgig-sdk/data-gov-au-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/data-gov-au-sdk \
      --repository voxgig-sdk/data-gov-au-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/data-gov-au-sdk` shows it, and
`npm trust revoke @voxgig-sdk/data-gov-au-sdk --id=<id>` removes it.
