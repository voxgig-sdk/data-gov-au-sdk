...
class DatasetEntity
  ...
  def make
    opts = @_entopts.dup
    DatasetEntity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Dataset.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dataset, Hash] the loaded Dataset; raises DataGovAuError on failure
