...
The Ruby SDK for the DataGovAu API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `DataGovAuError` (a `StandardError` subclass), so wrap
...
```
rb/
├── DataGovAu_sdk.rb       -- Main SDK module
