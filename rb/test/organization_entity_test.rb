...
class OrganizationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DATAGOVAU_TEST_ORGANIZATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def organization_basic_setup(extra)
  ...
  entid_env_raw = ENV["DATAGOVAU_TEST_ORGANIZATION_ENTID"]
