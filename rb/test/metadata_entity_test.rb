...
class MetadataEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DATA_GOV_AU_TEST_METADATA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def metadata_basic_setup(extra)
  ...
  entid_env_raw = ENV["DATA_GOV_AU_TEST_METADATA_ENTID"]
