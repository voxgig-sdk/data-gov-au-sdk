...
AQL-driven CLI and REPL for the DataGovAu SDK. Positional arguments are
...
./data-gov-au-cli list dataset
./data-gov-au-cli load 1 dataset
./data-gov-au-cli load '{id:1}' dataset
