...
func registerSDKWords(r *eng.Registry, client *sdk.DataGovAuSDK) {
...
func runOp(client *sdk.DataGovAuSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
