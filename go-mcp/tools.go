...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dataset | metadata | organization"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DataGovAuSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "data-gov-au_list",
		Description: "List records from DataGovAu. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "data-gov-au_load",
		Description: "Load a single record from DataGovAu. " +
...
func runOp(client *sdk.DataGovAuSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DataGovAuSDK, name string) (sdk.DataGovAuEntity, error) {
	switch strings.ToLower(name) {
	case "dataset":
		return client.Dataset(nil), nil
	case "metadata":
