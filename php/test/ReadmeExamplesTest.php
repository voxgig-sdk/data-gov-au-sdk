...
// DataGovAu SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DataGovAuSDK::test)
...
{
    private const SDK_CLASS = 'DataGovAuSDK';
    ...
    private const SDK_BASE = 'datagovau_sdk';
