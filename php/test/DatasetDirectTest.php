...
class DatasetDirectTest extends TestCase
{
    public function test_direct_load_dataset(): void
    {
        $setup = dataset_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dataset", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
