...
// DataGovAu SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DataGovAuOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DataGovAuOmni::structfix($now, Struct::undef()))
                        !== json_encode(DataGovAuOmni::structfix($val, Struct::undef()))) {
