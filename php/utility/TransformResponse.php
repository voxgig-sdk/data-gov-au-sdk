...
// DataGovAu SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DataGovAuTransformResponse
{
    public static function call(DataGovAuContext $ctx): mixed
    {
        ...
        $transform = DataGovAuHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
