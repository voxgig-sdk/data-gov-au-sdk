...
class DataGovAuGraphql
{
    ...
    // equivalent.
    public static function body(DataGovAuContext $ctx): mixed
    {
    ...
    public static function errors(DataGovAuContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
