...
// DataGovAu SDK ratelimit feature
...
class DataGovAuRatelimitFeature extends DataGovAuBaseFeature
{
    ...
    private function _acquire(DataGovAuContext $ctx): void
    {
    ...
    private function _track(DataGovAuContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
