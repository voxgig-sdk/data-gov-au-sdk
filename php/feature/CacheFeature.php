...
class DataGovAuCacheFeature extends DataGovAuBaseFeature
{
    ...
    private function _through(DataGovAuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
