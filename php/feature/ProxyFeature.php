...
class DataGovAuProxyFeature extends DataGovAuBaseFeature
{
    ...
    public function init(DataGovAuContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DataGovAuContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
