...
class DataGovAuTimeoutFeature extends DataGovAuBaseFeature
{
    ...
    private function _with_timeout(DataGovAuContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DataGovAuContext $_ctx, float $ms): void
    {
        $client = $this->client;
