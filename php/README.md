...
The PHP SDK for the DataGovAu API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->DataGovAu(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── datagovau_sdk.php          -- Main SDK class
...
The main class (`datagovau_sdk.php`) exports the SDK class
