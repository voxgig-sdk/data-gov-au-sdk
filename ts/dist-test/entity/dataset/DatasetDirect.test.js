...
(0, node_test_1.describe)('DatasetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DataGovAuSDK({
    ...
    (0, node_test_1.test)('direct-load-dataset', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-dataset', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DATA_GOV_AU_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DataGovAuSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.DATA_GOV_AU_APIKEY,
        }));
        let idmap = env['DATA_GOV_AU_TEST_DATASET_ENTID'];
    ...
    const client = new __1.DataGovAuSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DatasetDirect.test.js.map