...
function envOverride(m) {
    if ('TRUE' === process.env.DATA_GOV_AU_TEST_LIVE ||
        'TRUE' === process.env.DATA_GOV_AU_TEST_OVERRIDE) {
    ...
    m.DATA_GOV_AU_TEST_EXPLAIN = process.env.DATA_GOV_AU_TEST_EXPLAIN || m.DATA_GOV_AU_TEST_EXPLAIN;
    return m;
}
