...
| `tester(testopts?, sdkopts?)` | `DataGovAuSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DataGovAuSDK.test(testopts?, sdkopts?)` | `DataGovAuSDK` | Create a test-mode client. |
...
| `client` | `client(): DataGovAuSDK` | Return the parent SDK client. |
...
data-gov-au/
├── src/
│   ├── DataGovAuSDK.ts        # Main SDK class
