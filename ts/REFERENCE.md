# DataGovAu TypeScript SDK Reference

Complete API reference for the DataGovAu TypeScript SDK.
...
```ts
new DataGovAuSDK(options?: object)
```
...
#### `DataGovAuSDK.test(testopts?, sdkopts?)`
...
**Returns:** `DataGovAuSDK` instance in test mode.
...
Return the parent `DataGovAuSDK` instance.
